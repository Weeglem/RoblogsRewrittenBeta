...
<body>
    ...
    <div class="UploadForm Hidden" id="MainMenu">
        <h1>You are about to Publish this Model on ROBLOGS. Please choose how you would like to save your work:</h1>
        <div class="GotoPart">
            <div class="GoToInside">
                <div class="ButtonGoto-Show"><button id="NewItem_Button" class="GoTobutton">Create</button></div>
                <div class="ButtonGoto-Explain">
                    <p><strong>Create a new Model on ROBLOGS.</strong></p>
                    <p>Choose this to create a brand new Model.Your existing Models will not be changed.</p>
                </div>
            </div>

            <div class="GoToInside">
                <div class="ButtonGoto-Show"><button id="UpdateItem_Button" class="GoTobutton">Update</button></div>
                <div class="ButtonGoto-Explain">
                    <p><strong>Update an existing Model on ROBLOGS.</strong></p>
    ...
    <div class="UploadForm Hidden" id="NewItem">
        <form id="NewItemForm">
            <div class="FormPart">
            ...
            <div class="FormPart">
                ...
                <div>
                    ...
                    <div class="FormButtons-Action Margin13">
                        <div class="FormButtons-Row">
                            <input type="checkbox" name="Private" id="Private">
                            <label for="Private">Publish for free public use.</label>
                        </div>
                        <div class="FormButtons-Row Margin13 TextRight">
                            <button type="submit" id="CreateModel">Upload</button>
    ...
    <input type="text" readonly="true" name="type" id="Itemtype" value="Models" style="display:none">
</body>
