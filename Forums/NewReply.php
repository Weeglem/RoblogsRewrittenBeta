...
<!DOCTYPE html>
<html lang="en">
<?php $Page_CSS = "Forums_Form"; $Page_Title = "Reply to Post"?>
<?php include($_SERVER["DOCUMENT_ROOT"]."/Roblogs_Server/Templates/Top.php");?>
    <div class="ForumContainer">
        ...
        <div class="ForumHeader">
            ...
            ForumTree($ID,"ShowPost",false,"Reply"); ?>
        </div>
        ...
        <div class="ForumFormBody BlueNormal">
            <h1 class="BlueBG Title">Reply to an existing message</h1>
            <div class="FormReply-Brief">
                <p>The message you are replying to:</p>
            ...
            <div class="FormPart">
                ...
                <div class="FormPart">
                    ...
                    <span class="BigText">Re: <?=$Name?></span>
                </div>
                <div class="FormPart">
                ...
                <div class="FormPart ButtonPart"><button id="SubmitButton" value="Reply">Reply</button></div>
            </form>
        </div>
