...
try{
    ...
    $ZipHandler->SetAllowedTypes(array("rbxl")); //ONLY rbxl
...
$Thumbs_FinalFolder = WebsiteLinks::ServerThumbs_Games();
$Roblox_FinalFolder = WebsiteLinks::Server_GamesFolder();


file_put_contents("$Roblox_FinalFolder/$NewItem",$RobloxData); //create GZIP Roblox File
rename("$TempFolder/$ThumbnailTemp.png","$Thumbs_FinalFolder/".$NewItem."Thumbnail.png"); //Rename Thumbnail File
